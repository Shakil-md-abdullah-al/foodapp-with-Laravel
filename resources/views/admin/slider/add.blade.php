                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">Add Slider</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="price" class="form-label">Subheading</label>
                                    <input type="text" class="form-control" id="price" name="subname" placeholder="Enter the price" required>
                                </div>
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="btn btn-outline-success text-center">Add Slider</button>
                                </div>
                            </form>
                        </div>
                    </div>
