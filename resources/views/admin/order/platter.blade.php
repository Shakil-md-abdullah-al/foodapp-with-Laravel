                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                @if($product->delivery_status=='Processing')
                                    ...
                                    <div class="btn-group">
                                        <a href="{{route('deliverPlatter',$product->id)}}" onclick="return confirm('Are You Sure to Deliver it??')" class="btn btn-primary">Delivered</a>
                            ...
                            <td><a href="{{route('print_Platter_pdf',$product->id)}}" class="btn btn-secondary">Print PDF</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
